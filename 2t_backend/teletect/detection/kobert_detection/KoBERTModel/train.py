from teletect.detection.kobert_detection.KoBERTModel.BERTClassifier import BERTClassifier
from teletect.detection.kobert_detection.KoBERTModel.BERTDataset import BERTDataset
...
from teletect.detection.kobert_detection.KoBERTModel.filedir import get_local_file, MODEL_PATH
...
def run():
    ...
    dataset = pd.read_csv(get_local_file('static/csv/KoBERT_dataset_v2.5.csv')).sample(frac=1.0)
    dataset.sample(n=15)
    dataset_tsv = []
