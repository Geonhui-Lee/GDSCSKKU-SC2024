...
from teletect.detection.kobert_detection.KoBERTModel.filedir import get_local_file
...
class voice:
    def __init__(self):
        ...
        self.df = pd.read_csv(get_local_file("static/csv/500_가중치.csv"), encoding='utf-8')             # 전체 형태소 분석 (가중치) 파일 
        self.type_df = pd.read_csv(get_local_file("static/csv/type_token_가중치.csv"), encoding='utf-8') # 범죄 유형 분류 기준 단어 파일
